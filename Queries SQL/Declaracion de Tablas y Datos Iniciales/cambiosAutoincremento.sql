...
(501, 'Colonia Universidad', 'Boulevard Los Pr�ceres #1234'),
(501, 'Barrio R�o de Piedras', 'Ave. Circunvalaci�n #5678'),
...
(511, 'Colonia San Jos�', 'Carretera CA-5 Km 15'),
(512, 'Barrio El Progreso', 'Ave. La Lima #789'),
(504, 'Aldea San Antonio', 'Desv�o La Barca Km 3'),
(503, 'Casco Hist�rico', 'Calle del Comercio #456'),
(510, 'El Para�so', 'Orilla del Lago de Yojoa'),
...
('Riego por Goteo', 'Se suministra agua directamente a las ra�ces de las plantas.'),
('Riego por Aspersi�n', 'Utiliza aspersores para distribuir el agua en el terreno.'),
('Riego por exudaci�n', 'El agua se libera lentamente a trav�s de tubos porosos.'),
('Riego por Microaspersi�n', 'Sistema de riego localizado con microaspersores de bajo caudal'),
('Riego por superficie o inundaci�n', 'Se aplica agua directamente sobre el suelo.'),
...
('Jos� Manuel Flores', 'Agricultor', '0502199812345', '05021998123456', 'joseflores@email.com', '9876-5432', 4, 'Productor de pl�tano en Choloma',0),
...
('Carmen Elena Mej�a', 'Agricultor', '0511198734567', '05011987345678', 'carmenmejia@email.com', '8765-4321', 6, 'Productora org�nica en Villanueva', 0),
...
('Insumos Agr�colas', 'Proveedor', '0501199167890', '05011991678901', 'info@insumoscortes.hn', '2559-8901', 9, 'Proveedor de semillas certificadas', 0),
('Ana Sof�a Castillo', 'Agricultor', '0510198978901', '05101989789012', 'ana.castillo@email.com', '9543-2109', 10, 'Cultivos de exportaci�n Lago Yojoa' , 0),
...
(1, 'Finca San Jos�', 4, 'Alta'),
(3, 'Finca Org�nica', 6, 'Media'),
(5, 'Finca El Para�so', 7, 'Alta'),
(7, 'Finca Lago Verde', 10, 'Alta'),
(1, 'Finca Los Pl�tanos', 4, 'Media');
...
('Granos B�sicos', 'Producto Agricola'),
('Herramientas', 'Insumo'),
('Cultivos Exportaci�n', 'Producto Agricola');
...
-- Productos Agr�colas (T�picos de Cort�s)
(4, 7, 'Banano'),
(4, 7, 'Pl�tano Verde'),
(5, 1, 'Tomate'),
(5, 1, 'Lechuga Iceberg'),
...
--Se agreg� productos con lista de precio costo y se arreglo la tabla ya que como estaba no se podian agregar mas precios
...
(1, 11, 1, 3, '2024-03-15', '2024-07-15', 255.50),  -- Tomate Cherry en Finca San Jos�
(1, 15, 3, 2, '2024-01-10', '2024-12-10', 536.00),    -- Caf� en Finca San Jos�
(2, 12, 2, 4, '2024-04-01', '2024-06-01', 365.75),   -- Lechuga en Finca Las Flores
(3, 13, 1, 5, '2024-05-20', '2024-10-20', 365.25),        -- Ma�z en Finca El Para�so
