...
as
	begin
		SELECT VD.VentaID, P.ProductoID, P.Nombre as 'Producto', I.ImpuestoID, I.Nombre as 'Impuesto', I.Valor, B.BodegaID, 
		B.Nombre as 'Bodega', VD.Cantidad, VD.Precio, VD.Total 
