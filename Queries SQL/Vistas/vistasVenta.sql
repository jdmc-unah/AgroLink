...
as
	...
	SELECT V.VentaID, V.CodigoVenta, V.Fecha , S.Nombre as 'Socio' , S.TipoSocio , LP.Nombre as 'ListaPrecio', V.TipoPago, V.Estado,  SUM( (VD.Cantidad * VD.Precio) * (1+I.Valor) ) as 'Total'
	...
	GROUP BY  V.VentaID, V.CodigoVenta, V.Fecha , S.Nombre ,  S.TipoSocio, LP.Nombre, V.TipoPago, V.Estado
