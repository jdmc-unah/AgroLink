...
as
select pl.CodigoLote,pf.CodigoFinca,pp.Nombre as 'Porducto Sembrado',ptr.nombre as 'Tipo de riego aplicado',pts.NombreComun 'Tipo de suelo',pl.FechaSiembra,pl.FechaCosecha from Pruebas.Lote pl inner join pruebas.finca pf on pl.FincaID=pf.FincaID
